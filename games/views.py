...
def new_player(request):
  ...
  if form_.is_valid():
    ...
    form_.save(for_player=player_)  # Game.objects.create(text=request.POST["text"], player=player_)
...
def view_player(request, player_id):
  ...
  # if request.method != "POST":
  #   form_ = GameForm()
  #   response = render(request, 'player.html', {'player': player_, "form": form_})
  # else:
  #   form_ = GameForm(data=request.POST)
  #   if form_.is_valid():
  #     form_.save(for_player=player_)
