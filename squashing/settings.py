'''
Django settings for squashing project.
...
WSGI_APPLICATION = 'squashing.wsgi.application'
...
EMAIL_HOST_USER = 'diego.villamil@squashitlan.com'  # diego.villamil@squashitlan.com
